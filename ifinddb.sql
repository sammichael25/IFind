...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2017 at 02:27 PM
...
INSERT INTO `room` (`roomId`, `floor`, `buildingId`) VALUES('FST 113', 'G', 100);
INSERT INTO `room` (`roomId`, `floor`, `buildingId`) VALUES('FST 114', 'G', 100);
INSERT INTO `room` (`roomId`, `floor`, `buildingId`) VALUES('FST 412', '3', 100);
INSERT INTO `room` (`roomId`, `floor`, `buildingId`) VALUES('FST CSL1', '2', 100);
INSERT INTO `room` (`roomId`, `floor`, `buildingId`) VALUES('FST CSL2', '2', 100);
...
INSERT INTO `user_course` (`userId`, `courseCode`) VALUES(1, 'INFO 3410');
...
ALTER TABLE `user_course`
  ...
  ADD CONSTRAINT `user_id_fk` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);
